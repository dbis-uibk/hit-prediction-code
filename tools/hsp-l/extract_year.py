...
interim_prefix = 'data/hit_song_prediction_lastfm/interim'
...
uuid_msd_mapping = pd.read_csv(
    os.path.join(interim_prefix, 'msd_lastfm_matches.csv'),
    header=0,
)[['uuid', 'msd_id']].drop_duplicates()
